...
#define ICE1BR0 "      _____________________________________________      "
#define ICE1BR1 "  _.-' == == ===     ###              === == == == '-._  "
#define ICE1BR2 "*|    __________                   _  _____________    | "
#define ICE1BR3 "*|   |__________|  ~~~~ICE~~~~    |O| |____________|   | "
#define ICE1BR4 "*|-------DB-----------------------|_|-------DB---------| "
#define ICE1BR5 " `---(o)~~~(o)-----------------------------(o)~~~(o)---' "
#define ICE1BR6 " `----(O)~~~(O)-----------------------------(O)~~~(O)--' "

/* ICE3RD Triebkopf (Redesign) */
#define ICE3RDHEIGHT    6
#define ICE3RDBR0 "                                                              "
#define ICE3RDBR1 "              _ ..------_-----------------------------'**`---,"
#define ICE3RDBR2 "         . _`,.---,---,|-| ,----,----,----,----,----,----,   |"
#define ICE3RDBR3 "      .' `..--'---'---'|=| '----'----'----'----'----'----'   |"
#define ICE3RDBR4 "    (_,..----- ICE ----|_|-----------------------------------|"
#define ICE3RDBR5 "      ````*(o)*~~*(o)*````````````````````````*(o)*~~*(o)*''' "
#define ICE3RDBR6 "      `````*(O)*~~*(O)*````````````````````````*(O)*~~*(O)*'' "

#define ICE3RDY0 "                                                              "
#define ICE3RDY1 ",---'**`-----------------------------_------.. _              "
#define ICE3RDY2 "|    ,----,----,----,----,----,----,|-|,---,---,.`_ .         "
#define ICE3RDY3 "|    '----'----'----'----'----'----'|=|'---'---'--..` '.      "
#define ICE3RDY4 "|-----------------------------------|_|---- ICE -----..,_)    "
#define ICE3RDY5 " '''*(o)*~~*(o)*````````````````````````*(o)*~~*(o)*````      "
#define ICE3RDY6 " ''*(O)*~~*(O)*````````````````````````*(O)*~~*(O)*`````      "
/* ICE3RD Wagen (aus ice3rd.txt) */
#define ICE3RDLENGTH   62
#define ICE3RDPATTERNS  2
#define ICE3RDWG0    "                                                              "
#define ICE3RDWG1    " ,-_-'**`---------------------------------------------'**`-_-,"
#define ICE3RDWG2    "#||-|    `` ,----,----,----,----,----,----,----,----,     |-||"
#define ICE3RDWG3    "#||=|       '----'----'----'----'----'----'----'----'     |=||"
#define ICE3RDWG4    "#||_|-----------------------------------------------------|_||"
#define ICE3RDWG5    "  ```*(o)*~~*(o)*`````````````````````````````*(o)*~~*(o)*''' "
#define ICE3RDWG6    "  ```*(O)*~~*(O)*`````````````````````````````*(O)*~~*(O)*''' "
#define ICE3RDWGDEL  "                                                              "
